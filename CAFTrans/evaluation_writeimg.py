...
def test_evaluation(args, model):
    ...
    pre = np.zeros((1, total_num))
    rec = np.zeros((1, total_num))
    accuracy = np.zeros((1, total_num))
    F1 = np.zeros((1, total_num))
    IOU = np.zeros((1, total_num))
    ...
    print("********************")
    print('mean value')
    print('pa_mean=', np.mean(pa))
    print('FWIoU_mean=', np.mean(FWIoU))
    print('mpa_mean=', np.mean(mpa))
